"""
reference: https://adventuresinmachinelearning.com/reinforcement-learning-tensorflow/
"""
import random

import gym
import lorasim as lorasim
from lorasim import loraDir
...
if __name__ == "__main__":
    ...
    env = loraDir
    nrNodes =loraDir.nrNodes
    num_states = 3*nrNodes
    num_actions = 5*nrNodes
